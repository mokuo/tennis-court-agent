...
class JapaneseHoliday < ActiveHash::Base
  ...
  self.data = [
    ...
    { id: 29, date: Date.parse("2021/7/23"), name: "スポーツの日" },
    { id: 30, date: Date.parse("2021/8/8"), name: "山の日" },
    { id: 31, date: Date.parse("2021/8/9"), name: "休日" },
    { id: 32, date: Date.parse("2021/9/20"), name: "敬老の日" },
    { id: 33, date: Date.parse("2021/9/23"), name: "秋分の日" },
    { id: 34, date: Date.parse("2021/10/11"), name: "スポーツの日" },
    { id: 35, date: Date.parse("2021/11/3"), name: "文化の日" },
    { id: 36, date: Date.parse("2021/11/23"), name: "勤労感謝の日" },
    { id: 37, date: Date.parse("2022/1/1"), name: "元日" },
    { id: 38, date: Date.parse("2022/1/10"), name: "成人の日" },
    { id: 39, date: Date.parse("2022/2/11"), name: "建国記念の日" },
    { id: 40, date: Date.parse("2022/2/23"), name: "天皇誕生日" },
    { id: 41, date: Date.parse("2022/3/21"), name: "春分の日" },
    { id: 42, date: Date.parse("2022/4/29"), name: "昭和の日" },
    { id: 43, date: Date.parse("2022/5/3"), name: "憲法記念日" },
    { id: 44, date: Date.parse("2022/5/4"), name: "みどりの日" },
    { id: 45, date: Date.parse("2022/5/5"), name: "こどもの日" },
    { id: 46, date: Date.parse("2022/7/18"), name: "海の日" },
    { id: 47, date: Date.parse("2022/8/11"), name: "山の日" },
    { id: 48, date: Date.parse("2022/9/19"), name: "敬老の日" },
    { id: 49, date: Date.parse("2022/9/23"), name: "秋分の日" },
    { id: 50, date: Date.parse("2022/10/10"), name: "スポーツの日" },
    { id: 51, date: Date.parse("2022/11/3"), name: "文化の日" },
    { id: 52, date: Date.parse("2022/11/23"), name: "勤労感謝の日" }
  ]
end
